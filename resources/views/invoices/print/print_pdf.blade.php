        ...
        <table>
            ...
            <thead>
                ...
                <tr>
                    <td colspan="2">
                        <h4>Company: </h4>
                        <p>PT. Aeon Vision Synergy.<br>
                            Komp. Windsor Blok A.15 Batam<br>
                            +62 778 450251 / +62 81381472143<br>
                            rudy.wilian@aeonvisionsynergy.com
                        </p>
                    </td>
                    <td colspan="2">
                        <h4>Billed To: </h4>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>SGD$ {{number_format($invoice->rate_hour,2)}}</td>
                    <td>
                        <?php $subtotal = $invoice->rate_hour * $invoice->total_hour; ?>
                        SGD$ {{number_format($subtotal,2)}}
                    </td>
                </tr>
                <tr>
                    <th colspan="3">Subtotal</th>
                    <td>SGD$ {{number_format($subtotal,2)}} </td>
                </tr>
                <tr>
                    <th>Discount</th>
                    <td colspan="2">SGD$ {{number_format($invoice->dicsount,2)}}</td>
                    <td>
                        <?php $subtotal = $subtotal - $invoice->dicsount; ?>
                        SGD$ {{number_format($subtotal,2)}}</td>
                </tr>
                <tr>
                    <th>PPN</th>
                    <td>SGD$ {{number_format($invoice->tax_value,2)}}</td>
                    <td>{{$invoice->tax}}%</td>
                    <td>
